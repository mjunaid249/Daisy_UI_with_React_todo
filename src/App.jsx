...
function App() {
  ...
  return (
    <>
      <Navbar />
      <main className="mt-10 flex items-center min-w-[50rem] justify-center flex-col ">
        {/* Add TODO   */}
        <form
          onSubmit={(e) => {
            e.preventDefault();
        ...
        >
          <input
            ...
            className="input input-bordered min-w-[26rem] max-w-xs"
          />
        ...
        <div className="todos flex flex-col gap-3 mt-7">
          {todoList.map((todo) => {
            return (
              <div
                key={todo.id}
                className="card max-h-[6rem] min-w-[30rem] bg-base-100 shadow-xl"
              >
